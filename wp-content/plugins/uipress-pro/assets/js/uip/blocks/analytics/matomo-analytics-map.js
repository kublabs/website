...
export function moduleData() {
  return {
    ...
    template: `
      ...
      <div class="uip-margin-bottom-xxs" v-if="showMatomoConnection"><uip-connect-matomo :success="refreshAnalytics"></uip-connect-matomo></div>
      ...
      :class="{'uip-dark-mode' : darkMapTheme || uipData.userPrefs.darkTheme}">
        <div id='uip-matomo-map' class="uip-matomo-map uip-w-300 uip-h-200"></div>
