		...
		public function csp_notices($notices){
			...
			if (get_option('rsssl_csp_max_size_exceeded')){
				$notices['csp_max_size'] = array(
					...
					'output' => array(
						'true' => array(
							'title' => __("Content Security Policy maximum size exceeded", "really-simple-ssl-pro"),
							'msg' => __("Your site has exceeded the maximum size for HTTP headers. To prevent issues, the Content Security Policy won't be added to your HTTP headers.", "really-simple-ssl-pro"),
							'icon' => 'warning',
							'url' => 'https://really-simple-ssl.com/instructions/content-security-policy-maximum-size-exceeded/',
							'plusone' => true,
							'dismissible' => true
						),
					),
